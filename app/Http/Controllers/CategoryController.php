...
class CategoryController extends Controller
{
    ...
    {   
        ...
        */$user = $APIController->getModel('AD_User', '', "Name eq '$name_user' and EMail eq '$email_user'", '', '', '', 'PAGODAHUB_closecash');
        ...
        return view('category.index', ['orgs' => $orgs,  'permisos' => $user]);
    }
    ...
    public function create()
    {
        ...
        */$user = $APIController->getModel('AD_User', '', "Name eq '$name_user' and EMail eq '$email_user'", '', '', '', 'PAGODAHUB_closecash');
        ...
        session()->put('misDatos', $orgs);
        //return view('tdc', ['orgs' => $orgs,  'permisos' => $user]);
        return view('category.create', ['orgs' => $orgs,  'permisos' => $user]);
    }
    ...
    public function edit(string $id)
    {
        ...
        */$user = $APIController->getModel('AD_User', '', "Name eq '$name_user' and EMail eq '$email_user'", '', '', '', 'PAGODAHUB_closecash');
        ...
        return view('category.edit', ['orgs' => $orgs,  'permisos' => $user,  'category' => $Category]);
    }
    ...
    public function destroy(string $id)
    {
        $Category = Category::find($id);
        $Category->delete();
        return back()->with('mensaje', 'Categoria ha sido eliminada exitosamente');
