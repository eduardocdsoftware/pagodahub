	            ...
	            <div class="card-header">
                    <div class="row">
                        <div class="col-md-12 d-flex justify-content-between">
                            ...
                            <div>
                                <a href="{{ route('product.create') }}" class="btn btn-primary font-weight-bold text-uppercase" style="font-size: 0.8rem !important;">Crear registro</a>
                            </div>
                        </div>
                    </div>
	            </div>
	            <div class="card-body">
	                @livewire('App\Http\Livewire\ProductSearch', ['orgs' => $orgs])
	            </div>
	        </div>
    	</div>
    </div>
