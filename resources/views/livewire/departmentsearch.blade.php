...
<div class="table-responsive">
    ...
    <table class="table table-bordered">
        <thead id="miTablaPersonalizada">
            <th>Nombre</th>
            <th style="width:20% !important;"><span class="mobile-hidden">Acciones</span></th>
        </thead>
        <tbody>
            @foreach ($departments as $data)
                <tr>
                    ...
                    <td style="width:20% !important;">
                        <a href="{{ route('department.edit', $data->id) }}" class="btn btn-warning btn-block my-1" style="width: 100% !important;">
                            ...
                            <span class="px-2 mobile-hidden">Editar</span>
                        </a>
                        <form action="{{ route('department.delete', $data->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-danger btn-block my-1" style="width: 100% !important;" onclick="return confirm('¿Estás seguro de que deseas eliminar este departmento?');">
                                ...
                                <span class="px-2 mobile-hidden">Eliminar</span>
                            </button>
                        </form>
                    </td>
                </tr>
