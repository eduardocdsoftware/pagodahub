            ...
            @foreach ($categories as $data)
                <tr>
                    ...
                    <td style="width:20% !important;">
                        <a href="{{ route('category.edit', $data->id) }}" class="btn btn-warning btn-block my-1" style="width: 100% !important;">
                        ...
                        <form action="{{ route('category.delete', $data->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-danger btn-block my-1" style="width: 100% !important;" onclick="return confirm('¿Estás seguro de que deseas eliminar esta categoria?');">
